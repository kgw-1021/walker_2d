    ...
    if __name__ == "__main__":
        ...
        eval_callback = EvalCallback(
            ...
            n_eval_episodes=5,
            deterministic=True,
            callback_on_new_best=lambda: env.save(log_dir + "vec_normalize_best.pkl")  # Best 모델 통계도 저장
        )

        sync_callback = SyncNormalizationCallback(env, eval_env)

        # 학습 시작
        model.learn(total_timesteps=500000, callback=[curriculum_cb, sync_callback, eval_callback], progress_bar=True)
